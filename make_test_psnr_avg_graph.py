...
file_paths = [dir_path + filename + '/' + dataname + '/' + 'psnr_' + filename + ".csv" for filename in file_names]
gragh_path = dir_path + method_name + '/' + dataname + '/' + 'graph' + '/' + "psnr/"
...
# plt.xlabel("frame")
plt.ylabel("psnr")
curr_gragh_path = gragh_path + "{}.png".format("psnr_avg")
