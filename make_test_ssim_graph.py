...
method_name ="ex_traffic_method1"
dataname = 'traffic48'
dir_path = "/home/jovyan/workdir/results/savedmat/grayscale/"
dir_path += method_name + '/' + dataname + '/' 'test' +'/'
file_names = [method_name, 'method1']
file_paths = [dir_path + 'ssim_' + filename + ".csv" for filename in file_names]
gragh_path = dir_path + "ssim/"
...
plt.xlabel("frame")
plt.ylabel("ssim")
curr_gragh_path = gragh_path + "{}.png".format("ssim")
