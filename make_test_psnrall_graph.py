...
file_paths1 = [dir_path + dirname + '/' + 'psnrall_' + method_name + ".csv" for dirname in dirnames]
file_paths2 = ["/home/jovyan/workdir/results/savedmat/grayscale/" + projmeth + '/' + comp + "/" + dirname + '/' + 'psnrall_' + comp + ".csv" for dirname in dirnames]

graph_path = dir_path + 'test' + '/' + "psnrall/"
