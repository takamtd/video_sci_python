...
from .my_models import FastDVDnet
from .my_fastdvdnet import fastdvdnet_seqdenoise, denoise_seq_fastdvdnet
from .my_utils import batch_psnr, init_logger_test, \
...
def fastdvdnet_denoiser(vnoisy, sigma, model=None, useGPU=True, gray=False):
	...
	# vnoisy = vnoisy.to(dtype='torch.FloatTensor', device=device)
